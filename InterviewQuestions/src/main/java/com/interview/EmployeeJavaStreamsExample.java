...
public class EmployeeJavaStreamsExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ID : " + highestPaidEmployee.toString());
        ...
        System.out.println("ID : " + youngestMaleEmployeeInProductDevelopment.toString());
        ...
        System.out.println(seniorMostEmployee.toString());
        ...
        System.out.println("Name : " + oldestEmployee.toString());

        //K = 3 th highest salary

        Optional<Employee> employee=employeeList.stream().sorted(Comparator.comparingDouble(Employee::getSalary).reversed()).skip(2).findFirst();
